document.addEventListener("DOMContentLoaded", function() {
    ...
    let indicator_diameter = 38;
    let indicator_st_out_width = 2.9;
...
@linear_grad_stops
    ...
    let svg_3_icons =
        ...
        <g id="circle" class="scale">
            <circle cx="19" cy="19" r="17.55" class="icons_st_out"/>
        </g>
        <g id="fail">
            <use xlink:href="#circle" class="fail"/>
            <path class="icon_w scale" d="M15.46,28.98c0-2.07,1.37-3.49,3.51-3.49,2,0,3.37,1.42,3.37,3.49,0,1.95-1.37,3.49-3.37,3.49-2.13,0-3.51-1.55-3.51-3.49ZM16.72,23.54h0l-.88-17.47h6.13l-.88,17.47h-4.37Z"/>
        </g>
        <g id="old_repair">
            <use xlink:href="#circle" class="repair"/>
            <path class="icon_w scale" d="M24.81,19.75l-5.15-1.09-1.06-5.05,5.29-5.2c-.79-.14-1.45-.27-2.25-.41-4.89,0-9.51,4.65-9.51,9.56,0,1.09.27,2.05.53,3.01l-8.34,8.03c1.53,2.34,3.6,4.29,6.04,5.67l8.24-8.09.13-.13c.66.13,1.33.27,2.11.27,4.89,0,9.51-4.65,9.51-9.56.14-.7,0-1.38-.27-2.2l-5.28,5.2Z"/>
        </g>
        <g id="old_lock_icon" class="scale">
            <path d="M10.49,9.32v18.97h18.18v1.45H9.04V9.3l1.45.02ZM22.9,16.23c-.43,5.51-5.69,9.21-11.21,8.32v2.85c7.15.88,13.33-4.11,13.93-10.84,1.28.18,1.89.28,3.35.48l-1.8-4.39-1.8-4.4-2.91,3.76-2.91,3.75c1.5.21,1.84.25,3.35.46h0Z"/>
        </g>
        <g id="old_lock_norm">
        ...
        <g id="insert">
            ...
            <path class="icon_w scale" d="M19.36,19l-9.63,7.67v-15.34l9.63,7.67ZM30.4,19l-9.64,7.67v-15.34l9.64,7.67Z"/>
        </g>
    </defs>
