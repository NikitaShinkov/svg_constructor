document.addEventListener("DOMContentLoaded", function() {
    ...
    let indicator_diameter = 24;
    let indicator_st_out_width = 2;
...
@linear_grad_stops
    ...
    let svg_3_icons =
        ...
        <g id="circle" class="scale">
            <circle cx="12" cy="12" r="11" class="icons_st_out"/>
        </g>
        <g id="fail">
            <use xlink:href="#circle" class="fail"/>
            <path class="icon_w scale" d="M9.78,18.25c0-1.3.86-2.19,2.2-2.19,1.25,0,2.12.89,2.12,2.19,0,1.22-.86,2.19-2.12,2.19-1.34,0-2.2-.97-2.2-2.19ZM10.57,14.84h0l-.55-10.95h3.84l-.55,10.95h-2.74Z"/>
        </g>
        <g id="old_repair">
            <use xlink:href="#circle" class="repair"/>
            <path class="icon_w scale" d="M14.99,12.7l-2.88-.61-.59-2.82,2.95-2.9c-.44-.08-.81-.15-1.25-.23-2.73,0-5.31,2.59-5.31,5.34,0,.61.15,1.15.3,1.68l-5.27,5.07c.88,1.28,2.04,2.36,3.37,3.17l5.21-5.12.07-.07c.37.07.74.15,1.18.15,2.73,0,5.31-2.59,5.31-5.34.08-.39,0-.77-.15-1.23l-2.95,2.9Z"/>
        </g>
        <g id="old_lock_icon" class="scale">
            <path d="M6.68,5.95v11.87h11.37v.9H5.77V5.93h.91ZM14.44,10.27c-.27,3.44-3.56,5.76-7.02,5.21v1.79c4.48.55,8.34-2.57,8.71-6.78.8.11,1.18.17,2.09.3l-1.12-2.75-1.12-2.75-1.82,2.35-1.82,2.35c.94.13,1.15.16,2.09.29h0Z"/>
        </g>
        <g id="old_lock_norm">
        ...
        <g id="insert">
            ...
            <path class="icon_w scale" d="M12.27,12l-5.37,4.28V7.72l5.37,4.28ZM18.44,12l-5.38,4.28V7.72l5.38,4.28Z"/>
        </g>
    </defs>
