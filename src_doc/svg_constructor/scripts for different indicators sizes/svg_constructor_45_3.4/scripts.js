document.addEventListener("DOMContentLoaded", function() {
    ...
    let indicator_diameter = 45;
    let indicator_st_out_width = 3.4;
...
@linear_grad_stops
    ...
    let svg_3_icons =
        ...
        <g id="circle" class="scale">
            <circle cx="22.5" cy="22.5" r="20.8" class="icons_st_out"/>
        </g>
        <g id="fail">
            <use xlink:href="#circle" class="fail"/>
            <path class="icon_w scale" d="M18.31,34.32c0-2.46,1.63-4.14,4.16-4.14,2.37,0,4,1.68,4,4.14,0,2.31-1.63,4.14-4,4.14-2.53,0-4.16-1.83-4.16-4.14ZM19.79,27.88h0l-1.04-20.7h7.26l-1.04,20.7h-5.18Z"/>
        </g>
        <g id="old_repair">
            <use xlink:href="#circle" class="repair"/>
            <path class="icon_w scale" d="M29.38,23.38l-6.11-1.3-1.26-5.99,6.27-6.16c-.93-.17-1.72-.32-2.66-.49-5.79,0-11.27,5.51-11.27,11.33,0,1.3.31,2.44.63,3.57l-9.88,9.52c1.81,2.77,4.27,5.08,7.16,6.72l9.77-9.59.16-.16c.79.16,1.57.32,2.5.32,5.79,0,11.27-5.51,11.27-11.33.17-.82,0-1.63-.31-2.6l-6.26,6.16Z"/>
        </g>
        <g id="old_lock_icon" class="scale">
            <path d="M12.42,11.03v22.49h21.55l-.02,1.71H10.7V11l1.72.03ZM27.12,19.22c-.51,6.53-6.75,10.92-13.29,9.86v3.38c8.48,1.04,15.79-4.87,16.5-12.85,1.52.21,2.24.33,3.97.57l-2.13-5.2-2.13-5.21-3.44,4.46-3.44,4.45c1.78.25,2.18.3,3.97.54h0Z"/>
        </g>
        <g id="old_lock_norm">
        ...
        <g id="insert">
            ...
            <path class="icon_w scale" d="M22.93,22.5l-11.42,9.09V13.41l11.42,9.09ZM36.02,22.5l-11.43,9.09V13.41l11.43,9.09Z"/>
        </g>
    </defs>
