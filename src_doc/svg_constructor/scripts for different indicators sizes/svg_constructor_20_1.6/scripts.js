document.addEventListener("DOMContentLoaded", function() {
    ...
    let indicator_diameter = 20;
    let indicator_st_out_width = 1.6;
...
@linear_grad_stops
    ...
    let svg_3_icons =
        ...
        <g id="circle" class="scale">
            <circle cx="10" cy="10" r="9.2" class="icons_st_out"/>
        </g>
        <g id="fail">
            <use xlink:href="#circle" class="fail"/>
            <path class="icon_w scale" d="M8.11,15.48c0-1.14.76-1.93,1.94-1.93,1.1,0,1.86.78,1.86,1.93,0,1.07-.76,1.93-1.86,1.93-1.18,0-1.94-.85-1.94-1.93ZM8.8,12.48h0l-.48-9.64h3.38l-.48,9.64h-2.41Z"/>
        </g>
        <g id="old_repair">
            <use xlink:href="#circle" class="repair"/>
            <path class="icon_w scale" d="M12.69,10.59l-2.53-.54-.52-2.48,2.6-2.55c-.39-.07-.71-.13-1.1-.2-2.4,0-4.67,2.28-4.67,4.7,0,.54.13,1.01.26,1.48l-4.33,4.17c.77,1.14,1.79,2.08,2.98,2.78l4.27-4.2.07-.07c.33.07.65.13,1.04.13,2.4,0,4.67-2.28,4.67-4.7.07-.34,0-.68-.13-1.08l-2.59,2.55Z"/>
        </g>
        <g id="old_lock_icon" class="scale">
            <path d="M5.37,4.64v10.45h10.01v.8H4.57V4.63h.8ZM12.2,8.45c-.24,3.03-3.13,5.07-6.17,4.58v1.57c3.94.48,7.34-2.26,7.67-5.97.71.1,1.04.15,1.84.26l-.99-2.42-.99-2.42-1.6,2.07-1.6,2.07c.82.12,1.01.14,1.84.25h0Z"/>
        </g>
        <g id="old_lock_norm">
        ...
        <g id="insert">
            ...
            <path class="icon_w scale" d="M10.3,9.97l-4.73,3.77v-7.53l4.73,3.77ZM15.72,9.97l-4.73,3.77v-7.53l4.73,3.77Z"/>
        </g>
    </defs>
