document.addEventListener("DOMContentLoaded", function() {
    ...
    let indicator_diameter = 28;
    let indicator_st_out_width = 2.1;
...
@linear_grad_stops
    ...
    let svg_3_icons =
        ...
        <g id="circle" class="scale">
            <circle cx="14" cy="14" r="12.95" class="icons_st_out"/>
        </g>
        <g id="fail">
            <use xlink:href="#circle" class="fail"/>
            <path class="icon_w scale" d="M11.33,21.54c0-1.61,1.07-2.71,2.72-2.71,1.55,0,2.62,1.1,2.62,2.71,0,1.51-1.07,2.71-2.62,2.71-1.66,0-2.72-1.2-2.72-2.71ZM12.3,17.31h0l-.68-13.56h4.76l-.68,13.56h-3.39Z"/>
        </g>
        <g id="old_repair">
            <use xlink:href="#circle" class="repair"/>
            <path class="icon_w scale" d="M17.78,14.82l-3.56-.76-.73-3.49,3.65-3.59c-.54-.1-1-.19-1.55-.29-3.38,0-6.58,3.21-6.58,6.61,0,.76.18,1.42.37,2.08l-6.1,5.87c1.08,1.6,2.52,2.93,4.19,3.91l6.02-5.91.09-.09c.46.09.92.19,1.46.19,3.38,0,6.58-3.21,6.58-6.61.1-.48,0-.95-.18-1.52l-3.65,3.59Z"/>
        </g>
        <g id="old_lock_icon" class="scale">
            <path d="M7.41,6.5v14.7h14.09v1.12H6.28V6.48l1.13.02ZM17.02,11.85c-.34,4.27-4.41,7.14-8.69,6.45v2.21c5.54.68,10.33-3.18,10.79-8.4.99.14,1.46.21,2.59.37l-1.39-3.4-1.39-3.41-2.25,2.91-2.25,2.91c1.16.16,1.43.2,2.59.35h0Z"/>
        </g>
        <g id="old_lock_norm">
        ...
        <g id="insert">
            ...
            <path class="icon_w scale" d="M14.42,14l-6.66,5.3v-10.6l6.66,5.3ZM22.05,14l-6.66,5.3v-10.6l6.66,5.3Z"/>
        </g>
    </defs>
