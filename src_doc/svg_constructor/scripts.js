document.addEventListener("DOMContentLoaded", function() {
    ...
    let indicator_diameter = 48;
    let indicator_st_out_width = 4;
...
@linear_grad_stops
    ...
    let svg_3_icons =
        ...
        <g id="circle" class="scale">
            <circle cx="24" cy="24" r="22" class="icons_st_out"/>
        </g>
        <g id="fail">
            <use xlink:href="#circle" class="fail"/>
            <path class="icon_w scale" d="M19.56,36.51c0-2.6,1.72-4.38,4.4-4.38,2.51,0,4.23,1.78,4.23,4.38,0,2.44-1.72,4.38-4.23,4.38-2.68,0-4.4-1.94-4.4-4.38ZM21.14,29.69h0l-1.1-21.9h7.68l-1.1,21.9h-5.48Z"/>
        </g>
        <g id="old_repair">
            <use xlink:href="#circle" class="repair"/>
            <path class="icon_w scale" d="M31.28,24.93l-6.46-1.37-1.33-6.34,6.63-6.51c-.99-.18-1.82-.34-2.82-.52-6.13,0-11.92,5.83-11.92,11.99,0,1.37.33,2.58.66,3.77l-10.46,10.07c1.92,2.93,4.51,5.38,7.57,7.11l10.34-10.15.17-.17c.83.17,1.66.34,2.65.34,6.13,0,11.92-5.83,11.92-11.99.18-.87,0-1.72-.33-2.75l-6.62,6.51Z"/>
        </g>
        <g id="old_lock_icon" class="scale">
            <path d="M13.34,11.87v23.79h22.79l-.02,1.81H11.52V11.84l1.82.03ZM28.89,20.53c-.54,6.9-7.14,11.55-14.06,10.43v3.58c8.97,1.1,16.71-5.15,17.46-13.59,1.61.23,2.37.35,4.2.6l-2.25-5.5-2.25-5.51-3.64,4.71-3.64,4.7c1.88.26,2.31.32,4.2.57h0Z"/>
        </g>
        <g id="old_lock_norm">
        ...
        <g id="insert">
            ...
            <path class="icon_w scale" d="M24.45,24l-12.08,9.61V14.39l12.08,9.61ZM38.3,24l-12.09,9.61V14.39l12.09,9.61Z"/>
        </g>
    </defs>
