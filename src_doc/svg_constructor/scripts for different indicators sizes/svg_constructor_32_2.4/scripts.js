document.addEventListener("DOMContentLoaded", function() {
    ...
    let indicator_diameter = 32;
    let indicator_st_out_width = 2.4;
...
@linear_grad_stops
    ...
    let svg_3_icons =
        ...
        <g id="circle" class="scale">
            <circle cx="16" cy="16" r="14.8" class="icons_st_out"/>
        </g>
        <g id="fail">
            <use xlink:href="#circle" class="fail"/>
            <path class="icon_w scale" d="M12.95,24.61c0-1.84,1.22-3.1,3.11-3.1,1.78,0,2.99,1.26,2.99,3.1,0,1.73-1.22,3.1-2.99,3.1-1.89,0-3.11-1.37-3.11-3.1ZM14.06,19.79h0l-.78-15.5h5.44l-.78,15.5h-3.88Z"/>
        </g>
        <g id="old_repair">
            <use xlink:href="#circle" class="repair"/>
            <path class="icon_w scale" d="M20.32,16.94l-4.07-.86-.84-3.99,4.18-4.1c-.62-.11-1.15-.22-1.77-.33-3.86,0-7.51,3.67-7.51,7.55,0,.86.21,1.62.42,2.38l-6.97,6.71c1.24,1.83,2.88,3.35,4.79,4.47l6.88-6.75.1-.1c.52.1,1.05.22,1.67.22,3.86,0,7.51-3.67,7.51-7.55.11-.55,0-1.09-.21-1.73l-4.17,4.1Z"/>
        </g>
        <g id="old_lock_icon" class="scale">
            <path d="M8.47,7.43v16.81h16.1v1.28H7.18V7.41l1.29.02ZM19.45,13.55c-.38,4.88-5.04,8.16-9.93,7.37v2.53c6.34.78,11.8-3.64,12.33-9.6,1.13.16,1.67.25,2.97.42l-1.59-3.89-1.59-3.89-2.57,3.33-2.57,3.32c1.33.19,1.63.23,2.97.4h0Z"/>
        </g>
        <g id="old_lock_norm">
        ...
        <g id="insert">
            ...
            <path class="icon_w scale" d="M16.48,16l-7.61,6.06v-12.12l7.61,6.06ZM25.2,16l-7.62,6.06v-12.12l7.62,6.06Z"/>
        </g>
    </defs>
