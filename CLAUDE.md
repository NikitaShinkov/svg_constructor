...
| Подсветка субъекта | Строка списка и фигура в предпросмотре подсвечивают друг друга: рамка `#3DB5FF` толщиной во внешнюю обводку поверх фигуры и та же рамка заливкой 10 % под ней. Рисуется двумя отдельными слоями над и под предпросмотром — **в выгружаемый файл ничего не добавляется**. Щелчок мимо субъектов — и в предпросмотре, и в пустой части списка — сворачивает все строки |
...
2. **Порядок субъектов правится вручную — и это нужно.** В черновике
